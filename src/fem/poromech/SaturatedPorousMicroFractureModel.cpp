...
#include "SaturatedPorousMicroFractureModel.h"
...
const char*  SaturatedPorousMicroFractureModel::DISP_NAMES[3]          = { "dx", "dy", "dz" };
const char*  SaturatedPorousMicroFractureModel::SHAPE_PROP             = "shape";
const char*  SaturatedPorousMicroFractureModel::MATERIAL_PROP          = "material";
...
const char*  SaturatedPorousMicroFractureModel::SOLID_STIFF_PROP       = "solidStiff";
const char*  SaturatedPorousMicroFractureModel::FLUID_STIFF_PROP       = "fluidStiff";
const char*  SaturatedPorousMicroFractureModel::POROSITY_PROP          = "porosity";
const char*  SaturatedPorousMicroFractureModel::BIOT_COEFF_PROP        = "biotCoeff";
const char*  SaturatedPorousMicroFractureModel::DTIME_PROP             = "dtime";

const char*  SaturatedPorousMicroFractureModel::SOLID_DENSITY_PROP     = "rhoSolid";
const char*  SaturatedPorousMicroFractureModel::FLUID_DENSITY_PROP     = "rhoFluid";
const char*  SaturatedPorousMicroFractureModel::GRAVITY_PROP           = "gravity";

const char*  SaturatedPorousMicroFractureModel::FRACTURE_POROSITY_PROP = "fracPorosity";
const char*  SaturatedPorousMicroFractureModel::RANDOM_POROSITY_PROP   = "randPorosity";

const char*  SaturatedPorousMicroFractureModel::PERM_TYPE_PROP         = "permType";
const char*  SaturatedPorousMicroFractureModel::FIXED_ISO_PERM         = "fixedIsoPerm";
const char*  SaturatedPorousMicroFractureModel::VOL_STRAIN_PERM        = "volStrainPerm";
const char*  SaturatedPorousMicroFractureModel::TENSILE_STRAIN_PERM    = "tensileStrainPerm";
const char*  SaturatedPorousMicroFractureModel::CUBIC_PERM             = "cubicPerm";
const char*  SaturatedPorousMicroFractureModel::CUBIC_ISO_PERM         = "cubicIsoPerm";

const char*  SaturatedPorousMicroFractureModel::PRESSURE_PSI_PROP      = "pressurePsi";
const char*  SaturatedPorousMicroFractureModel::FRACTURE_TYPE_PROP     = "fractureType";
const char*  SaturatedPorousMicroFractureModel::GRIFFITH_ENERGY_PROP   = "griffithEnergy";
...
const char*  SaturatedPorousMicroFractureModel::LINEAR_CZM              = "czmLinear";
const char*  SaturatedPorousMicroFractureModel::EXPONENTIAL_CZM         = "czmExponential";
const char*  SaturatedPorousMicroFractureModel::CORNELISSEN_CZM         = "czmCornelissen";
const char*  SaturatedPorousMicroFractureModel::HYPERBOLIC_CZM          = "czmHyperbolic";

vector<String> SaturatedPorousMicroFractureModel::fractureModels      (6);
vector<String> SaturatedPorousMicroFractureModel::permeabilityModels  (5);
...
SaturatedPorousMicroFractureModel::SaturatedPorousMicroFractureModel
...
void SaturatedPorousMicroFractureModel::configure
...
void SaturatedPorousMicroFractureModel::getConfig ( const Properties& conf,
...
bool SaturatedPorousMicroFractureModel::takeAction
...
void SaturatedPorousMicroFractureModel::getMatrix2_
...
void SaturatedPorousMicroFractureModel::getArcFunc_
...
void SaturatedPorousMicroFractureModel::getUnitLoad_
...
void SaturatedPorousMicroFractureModel::setTaylorHoodConstraints_ 
...
void  SaturatedPorousMicroFractureModel::initializeIPMPMap_ ( )
...
bool SaturatedPorousMicroFractureModel::getTable_
...
void SaturatedPorousMicroFractureModel::getStress_
...
void SaturatedPorousMicroFractureModel::getStrain_
...
void SaturatedPorousMicroFractureModel::getLocalPhaseField_
...
void SaturatedPorousMicroFractureModel::getHistory_
...
void SaturatedPorousMicroFractureModel::getOutputData_
...
void SaturatedPorousMicroFractureModel::checkCommit_
...
void SaturatedPorousMicroFractureModel::setStepSize_
...
//-----------------------------------------------------------------------
//   newSaturatedPorousMicroFractureModel
//-----------------------------------------------------------------------


static Ref<Model>     newSaturatedPorousMicroFractureModel
...
{
  return newInstance<SaturatedPorousMicroFractureModel> ( name, conf, props, globdat );
}
...
void declareSaturatedPorousMicroFractureModel ()
{
  ...
  ModelFactory::declare ( "SaturatedPorousMicroFracture", & newSaturatedPorousMicroFractureModel );
}
