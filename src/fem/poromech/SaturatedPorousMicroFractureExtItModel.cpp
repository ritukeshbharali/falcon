...
/** @file SaturatedPorousMicroFractureExtItModel.cpp
...
#include "SaturatedPorousMicroFractureExtItModel.h"
...
//=================================================================================================
//   class SaturatedPorousMicroFractureExtItModel
//=================================================================================================
...
const char*  SaturatedPorousMicroFractureExtItModel::DISP_NAMES[3]          = { "dx", "dy", "dz" };
const char*  SaturatedPorousMicroFractureExtItModel::SHAPE_PROP             = "shape";
const char*  SaturatedPorousMicroFractureExtItModel::MATERIAL_PROP          = "material";

const char*  SaturatedPorousMicroFractureExtItModel::GENERATE_NEW_SEED      = "generateNewSeed";
const char*  SaturatedPorousMicroFractureExtItModel::KEEP_OFF_DIAGS_PROP    = "keepOffDiags";
const char*  SaturatedPorousMicroFractureExtItModel::ARCLEN_MODE_PROP       = "arcLenMode";
const char*  SaturatedPorousMicroFractureExtItModel::CONVEXIFY_PROP         = "convexify";

const char*  SaturatedPorousMicroFractureExtItModel::INTRIN_PERM_PROP       = "intrinPerm";
const char*  SaturatedPorousMicroFractureExtItModel::FLUID_VISC_PROP        = "fluidVisc";
const char*  SaturatedPorousMicroFractureExtItModel::SOLID_STIFF_PROP       = "solidStiff";
const char*  SaturatedPorousMicroFractureExtItModel::FLUID_STIFF_PROP       = "fluidStiff";
const char*  SaturatedPorousMicroFractureExtItModel::POROSITY_PROP          = "porosity";
const char*  SaturatedPorousMicroFractureExtItModel::BIOT_COEFF_PROP        = "biotCoeff";
const char*  SaturatedPorousMicroFractureExtItModel::DTIME_PROP             = "dtime";

const char*  SaturatedPorousMicroFractureExtItModel::SOLID_DENSITY_PROP     = "rhoSolid";
const char*  SaturatedPorousMicroFractureExtItModel::FLUID_DENSITY_PROP     = "rhoFluid";
const char*  SaturatedPorousMicroFractureExtItModel::GRAVITY_PROP           = "gravity";

const char*  SaturatedPorousMicroFractureExtItModel::FRACTURE_POROSITY_PROP = "fracPorosity";
const char*  SaturatedPorousMicroFractureExtItModel::RANDOM_POROSITY_PROP   = "randPorosity";

const char*  SaturatedPorousMicroFractureExtItModel::PERM_TYPE_PROP         = "permType";
const char*  SaturatedPorousMicroFractureExtItModel::FIXED_ISO_PERM         = "fixedIsoPerm";
const char*  SaturatedPorousMicroFractureExtItModel::VOL_STRAIN_PERM        = "volStrainPerm";
const char*  SaturatedPorousMicroFractureExtItModel::TENSILE_STRAIN_PERM    = "tensileStrainPerm";
const char*  SaturatedPorousMicroFractureExtItModel::CUBIC_PERM             = "cubicPerm";
const char*  SaturatedPorousMicroFractureExtItModel::CUBIC_ISO_PERM         = "cubicIsoPerm";

const char*  SaturatedPorousMicroFractureExtItModel::PRESSURE_PSI_PROP      = "pressurePsi";
const char*  SaturatedPorousMicroFractureExtItModel::FRACTURE_TYPE_PROP     = "fractureType";
const char*  SaturatedPorousMicroFractureExtItModel::GRIFFITH_ENERGY_PROP   = "griffithEnergy";
const char*  SaturatedPorousMicroFractureExtItModel::LENGTH_SCALE_PROP      = "lengthScale";
const char*  SaturatedPorousMicroFractureExtItModel::TENSILE_STRENGTH_PROP  = "tensileStrength";
const char*  SaturatedPorousMicroFractureExtItModel::PENALTY_PROP           = "penalty";
const char*  SaturatedPorousMicroFractureExtItModel::MAX_OITER_PROP         = "maxOIter";
const char*  SaturatedPorousMicroFractureExtItModel::OITER_TOL_PROP         = "oIterTol";

const char*  SaturatedPorousMicroFractureExtItModel::BRITTLE_AT1             = "at1";
const char*  SaturatedPorousMicroFractureExtItModel::BRITTLE_AT2             = "at2";
const char*  SaturatedPorousMicroFractureExtItModel::LINEAR_CZM              = "czmLinear";
const char*  SaturatedPorousMicroFractureExtItModel::EXPONENTIAL_CZM         = "czmExponential";
const char*  SaturatedPorousMicroFractureExtItModel::CORNELISSEN_CZM         = "czmCornelissen";
const char*  SaturatedPorousMicroFractureExtItModel::HYPERBOLIC_CZM          = "czmHyperbolic";

vector<String> SaturatedPorousMicroFractureExtItModel::fractureModels      (6);
vector<String> SaturatedPorousMicroFractureExtItModel::permeabilityModels  (5);
...
SaturatedPorousMicroFractureExtItModel::SaturatedPorousMicroFractureExtItModel
...
void SaturatedPorousMicroFractureExtItModel::configure
...
void SaturatedPorousMicroFractureExtItModel::getConfig ( const Properties& conf,
...
bool SaturatedPorousMicroFractureExtItModel::takeAction
...
void SaturatedPorousMicroFractureExtItModel::getMatrix_
...
void SaturatedPorousMicroFractureExtItModel::getMatrix2_
...
void SaturatedPorousMicroFractureExtItModel::getArcFunc_
...
void SaturatedPorousMicroFractureExtItModel::getUnitLoad_
...
void SaturatedPorousMicroFractureExtItModel::setTaylorHoodConstraints_ 
...
void  SaturatedPorousMicroFractureExtItModel::initializeIPMPMap_ ( )
...
bool SaturatedPorousMicroFractureExtItModel::getTable_
...
void SaturatedPorousMicroFractureExtItModel::getStress_
...
void SaturatedPorousMicroFractureExtItModel::getStrain_
...
void SaturatedPorousMicroFractureExtItModel::getLocalPhaseField_
...
void SaturatedPorousMicroFractureExtItModel::getHistory_
...
void SaturatedPorousMicroFractureExtItModel::getOutputData_
...
void SaturatedPorousMicroFractureExtItModel::checkCommit_
...
void SaturatedPorousMicroFractureExtItModel::setStepSize_
...
//-----------------------------------------------------------------------
//   newSaturatedPorousMicroFractureExtItModel
//-----------------------------------------------------------------------


static Ref<Model>     newSaturatedPorousMicroFractureExtItModel
...
{
  return newInstance<SaturatedPorousMicroFractureExtItModel> ( name, conf, props, globdat );
}
...
void declareSaturatedPorousMicroFractureExtItModel ()
{
  ...
  ModelFactory::declare ( "SaturatedPorousMicroFractureExtIt", & newSaturatedPorousMicroFractureExtItModel );
}
