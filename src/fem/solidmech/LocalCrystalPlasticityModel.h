...
/** @file LocalCrystalPlasticityModel.h
...
/** @brief Implements a local crystal visco-plasticity FE model.
 * 
...
class LocalCrystalPlasticityModel : public Model
{
  
 public:

  typedef LocalCrystalPlasticityModel  Self;
  typedef Model                        Super;
 ...
 protected:
  ...
  virtual                  ~LocalCrystalPlasticityModel  ();
